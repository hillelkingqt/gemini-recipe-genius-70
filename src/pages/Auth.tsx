...
<button
  ...
  className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center h-full text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none"
>
  {showSignInPassword ? (
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="relative">
                            ...
                            <button
                              ...
                              className="absolute top-1/2 right-3 -translate-y-1/2 text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none"
                            >
                              {showSignUpPassword ? (
                                <EyeOff className="w-5 h-5" />
                              ) : (
